...
function ListMap() {
    ...
    // map의 인자로 넘어사는 콜백함수의 return값을 이용해 새로운 배열을 생성함.
    //[<li>a</li>,<li>b</li>,<li>c</li>]

    const addProduct = () => {
        // list와 추가할 객체를 합쳐줘야 함
        // 원래라면 새로운 상품을 back에서 insert하고 생긴 고유 primary 값을 id에 담아주면 좋겠죠?
        // 그치만 지금은 
    ...
    const deleteProduct = (id) => {
        ...
        // redering할 때 list 배열을 이용함. -> list 배열에서 원하는 원소를 삭제해야함. 
